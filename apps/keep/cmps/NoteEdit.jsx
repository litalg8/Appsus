...
export class NoteEdit extends React.Component {
    ...
    onInputChange = (ev) => {
        ...
        this.setState({ note: { ...this.state.note, info: { ...this.state.note.info, txt: ev.target.value }} , 
    ...
    addNote = (ev) => {
        ...
        var note = keepService.createNote(this.state.type,this.state.value)
    ...
    render() {
        ...
        return (
            <div className="note-edit">
                ...
                <button onClick={this.addNote} samesite="None">add note</button>
